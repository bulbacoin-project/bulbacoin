...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.8 -arch i386 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk
...
macx:ICON = src/qt/res/icons/bulbacoin.icns
